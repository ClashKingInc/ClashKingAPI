...
// @Router /v2/mobile/public-config [get]
...
// @Produce json
// @Security ApiKeyAuth
// @Param body body models.MobilePlayerTagsRequest true "Initialization payload"
// @Success 200 {object} map[string]interface{}
// @Failure 400 {object} map[string]interface{}
// @Failure 401 {object} map[string]interface{}
// @Router /v2/mobile/initialization [post]
func mobileInitialization(a apptypes.Deps) fiber.Handler {
	return func(c *fiber.Ctx) error {
		var body models.MobilePlayerTagsRequest
