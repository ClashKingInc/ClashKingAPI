...
import { RuntimeInteractionProof, RuntimeUUID, TicketAccountSelectForm, TicketStringSelectForm,
  TicketModalForm, TicketContinueForm } from "./persistent-runtime.js"
...
const base = { auth: "bot", body: RuntimeInteractionProof, bodyMode: "json", method: "POST", query: NoQuery,
  responseMode: "json", successStatus: 200, errors } as const
