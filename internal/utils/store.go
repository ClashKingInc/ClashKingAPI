...
type Collections struct {
	...
	Ticketing            *mongo.Collection
	OpenTickets          *mongo.Collection
	Embeds               *mongo.Collection
	LegendRankings       *mongo.Collection
	PlayerHistory        *mongo.Collection
	JoinLeaveHistory     *mongo.Collection
	LegendHistory        *mongo.Collection
	WarTimer             *mongo.Collection
	PlayerLeaderboard    *mongo.Collection
	CWLGroups            *mongo.Collection
	PlayerTrophies       *mongo.Collection
	PlayerVersusTrophies *mongo.Collection
	ClanTrophies         *mongo.Collection
	ClanVersusTrophies   *mongo.Collection
	CapitalTrophies      *mongo.Collection
}
...
func NewStore(ctx context.Context, cfg Config) (*Store, error) {
	...
	return &Store{
		...
		C: Collections{
			...
			Ticketing:            db.Usafam.Collection("tickets"),
			OpenTickets:          db.Usafam.Collection("open_tickets"),
			Embeds:               db.Usafam.Collection("custom_embeds"),
			LegendRankings:       db.NewLooper.Collection("legend_rankings"),
			PlayerHistory:        db.NewLooper.Collection("player_history"),
			JoinLeaveHistory:     db.Looper.Collection("join_leave_history"),
			LegendHistory:        db.Looper.Collection("legend_history"),
			WarTimer:             db.Looper.Collection("war_timer"),
			PlayerLeaderboard:    db.RankingHistory.Collection("player_leaderboard"),
			CWLGroups:            db.Looper.Collection("cwl_group"),
			PlayerTrophies:       db.RankingHistory.Collection("player_trophies"),
			PlayerVersusTrophies: db.RankingHistory.Collection("player_versus_trophies"),
			ClanTrophies:         db.RankingHistory.Collection("clan_trophies"),
			ClanVersusTrophies:   db.RankingHistory.Collection("clan_versus_trophies"),
			CapitalTrophies:      db.RankingHistory.Collection("capital"),
		},
	}, nil
}
