...
export const DashboardRosterAccountGroupsQueryEndpoint = defineEndpoint({
    ...
    response: Schema.Struct({ groups: Schema.Array(Schema.Struct({ group: Schema.Number, accounts: Schema.Array(Schema.Struct({ rosterId: Schema.String, playerTag: Schema.String, playerName: Schema.String })) })), note: Schema.String }), responseMode: "json", successStatus: 200, errors,
