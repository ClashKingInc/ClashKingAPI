/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/api/wrangler.jsonc workers/api/worker-configuration.d.ts` (hash: 98bd3c45f2d7b9ea12c5d591555e5b03)
