...
) => defineEndpoint({ operationId, method: "GET", path, auth: "user-or-bot", summary: operationId, body: NoBody, bodyMode: "none", pathParams, query, response, responseMode: "json", successStatus: 200, errors: ProxyErrors })
