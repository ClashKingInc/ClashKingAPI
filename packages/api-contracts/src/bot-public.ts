...
const publicGet = <P extends ContractSchema, Q extends ContractSchema, R extends ContractSchema>(
  operationId: string,
  path: `/v2/${string}`,
  pathParams: P,
  query: Q,
...
export const BotPlayerHistoryEndpoint = publicGet(
  "botPlayerHistory", "/v2/player/:tag/history/changes", ClashTagPath,
  Schema.Struct({
