...
type ServerSettingsUpdate struct {
	...
	FullWhitelistRole  any                `json:"full_whitelist_role,omitempty"`
	...
	Banlist            any                `json:"banlist,omitempty"`
	StrikeLog          any                `json:"strike_log,omitempty"`
	RedditFeed         any                `json:"reddit_feed,omitempty"`
