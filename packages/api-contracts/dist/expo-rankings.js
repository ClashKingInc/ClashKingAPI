...
const clanLeaderboardEndpoint = (operationId, path) => defineEndpoint({ operationId, method: "GET", path, auth: "public", summary: operationId, body: NoBody, bodyMode: "none", pathParams: Schema.Struct({ locationId: Schema.Number }), query: LimitQuery, response: ClanLeaderboardResponse, responseMode: "json", successStatus: 200 });
