...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/boost-rate": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Start season YYYY-MM",
                        "name": "start_season",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "End season YYYY-MM",
                        "name": "end_season",
                        "in": "query",
                        "required": true
                    }
        ...
        "/ck/bulk": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Bearer internal API token",
                        "name": "Authorization",
                        "in": "header",
                        "required": true
                    },
                    {
                        "description": "Proxy paths",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v2/mobile/live-activities": {
            "post": {
                ...
                "description": "Registers or updates a mobile live activity push token.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Register mobile live activity",
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v2.mobileLiveActivityRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v2/mobile/live-activities/{activity_id}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "description": "Marks a mobile live activity as ended for the authenticated user.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "End mobile live activity",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Live activity ID",
                        "name": "activity_id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/v2/mobile/push/devices": {
            "post": {
                ...
                "description": "Registers or updates a mobile push token for the authenticated user.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v2.mobilePushDeviceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v2/mobile/push/devices/{device_id}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "description": "Disables a mobile push device for the authenticated user.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "Disable mobile push device",
                "parameters": [
                    {
                        "type": "string",
        ...
        "/v2/mobile/push/war-subscriptions": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "description": "Creates or updates war push subscription preferences for a device and clan.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Update mobile war subscription",
                "parameters": [
                    {
                        "description": "War subscription",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v2.mobileWarSubscriptionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "v2.mobileWarSubscriptionRequest": {
            "type": "object",
            "properties": {
                "clan_tag": {
                    "type": "string"
