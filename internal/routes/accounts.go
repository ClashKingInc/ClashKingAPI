...
// @Produce json
// @Security ApiKeyAuth
// @Param body body models.AccountsCOCAccountRequest true "Account payload"
...
// @Produce json
// @Security ApiKeyAuth
// @Param body body models.AccountsCOCAccountRequest true "Verified account payload"
// @Success 200 {object} map[string]interface{}
// @Failure 400 {object} map[string]interface{}
...
func addAccount(a apptypes.Deps, requireVerification bool) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		var body models.AccountsCOCAccountRequest
...
// @Produce json
// @Security ApiKeyAuth
// @Param body body models.AccountsReorderAccountsRequest true "Reorder payload"
// @Success 200 {object} map[string]interface{}
// @Failure 400 {object} map[string]interface{}
// @Failure 401 {object} map[string]interface{}
...
func reorderAccounts(a apptypes.Deps) fiber.Handler {
	return func(c *fiber.Ctx) error {
		userID := apptypes.UserID(c.UserContext())
		var body models.AccountsReorderAccountsRequest
		if err := apptypes.DecodeJSON(c, &body); err != nil {
			return err
		}
...
// @Security ApiKeyAuth
// @Param player_tag path string true "Player tag"
// @Param body body models.AccountsCOCAccountRequest true "Verification payload"
// @Success 200 {object} map[string]interface{}
// @Failure 400 {object} map[string]interface{}
// @Failure 401 {object} map[string]interface{}
// @Failure 403 {object} map[string]interface{}
