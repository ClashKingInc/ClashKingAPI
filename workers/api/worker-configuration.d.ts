/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d0b42ab0638998a4bd2361ed8ac3843c)
// Runtime types generated with workerd@1.20260831.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	API_CACHE: KVNamespace;
	WAR_ARCHIVE: R2Bucket;
	POSTS: R2Bucket;
	APP_UPDATES: R2Bucket;
	MEDIA: R2Bucket;
	TICKETING: R2Bucket;
	...
	DISCORD_MAIN_APPLICATION_ID: "";
	DISCORD_TICKET_NOTIFICATIONS_ENABLED: "false";
	...
	ADMIN_NOTIFICATION_LAB_ENABLED: "false";
	CONNECT_PUBLIC_ORIGIN: "https://connect.clashk.ing";
	ADMIN_ALLOWED_ORIGINS: "http://localhost:5173";
	WEB_ALLOWED_ORIGINS: "http://localhost:3002,http://localhost:8081";
	ACCESS_TEAM_DOMAIN: "";
	ACCESS_AUDIENCE: "";
	...
	ANDROID_MINIMUM_VERSION: "0.0.0";
	ANDROID_STORE_URL: "https://play.google.com/store/apps/details?id=ing.clashk";
	FORCED_UPDATE_MESSAGE: "A newer version of ClashKing is required.";
	POSTS_PUBLIC_ORIGIN: "https://posts.clashk.ing";
	APP_UPDATES_PUBLIC_ORIGIN: "https://updates.clashk.ing";
	TENOR_ALLOWED_HOSTS: "tenor.com,www.tenor.com";
	TENOR_MEDIA_ALLOWED_HOSTS: "media.tenor.com,c.tenor.com";
	MATERIALIZED_VIEW_REFRESHER: DurableObjectNamespace<import("./src/index").MaterializedViewRefresher>;
	SHARED_LINKS_LIMITER: DurableObjectNamespace<import("./src/index").SharedLinksRateLimiter>;
	TICKET_RUNTIME: DurableObjectNamespace<import("./src/index").TicketRuntimeCoordinator>;
	RUNTIME_RECOVERY: DurableObjectNamespace<import("./src/index").RuntimeRecoveryCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MaterializedViewRefresher" | "SharedLinksRateLimiter" | "TicketRuntimeCoordinator" | "RuntimeRecoveryCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "STRIPE_MONTHLY_PRICE_ID" | "STRIPE_CHECKOUT_SUCCESS_URL" | "STRIPE_CHECKOUT_CANCEL_URL" | "STRIPE_PORTAL_RETURN_URL" | "ROSTER_REFRESH_COOLDOWN_MINUTES" | "AI_ROSTER_MAX_PROMPT_CHARS" | "ELASTICSEARCH_PLAYERS_ALIAS" | "ELASTICSEARCH_CLANS_ALIAS" | "DISCORD_API_ORIGIN" | "DISCORD_PUBLIC_KEY" | "DISCORD_APPLICATION_ID" | "DISCORD_MAIN_APPLICATION_ID" | "DISCORD_TICKET_NOTIFICATIONS_ENABLED" | "DISCORD_REDIRECT_URI" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_STARTTLS" | "SMTP_SSL_TLS" | "SMTP_FROM_ADDRESS" | "SMTP_REPLY_TO_ADDRESS" | "ADMIN_NOTIFICATION_LAB_ENABLED" | "CONNECT_PUBLIC_ORIGIN" | "ADMIN_ALLOWED_ORIGINS" | "WEB_ALLOWED_ORIGINS" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUDIENCE" | "NATIVE_TOKEN_AUDIENCE" | "WEB_TOKEN_AUDIENCE" | "IOS_MINIMUM_VERSION" | "IOS_STORE_URL" | "ANDROID_MINIMUM_VERSION" | "ANDROID_STORE_URL" | "FORCED_UPDATE_MESSAGE" | "POSTS_PUBLIC_ORIGIN" | "APP_UPDATES_PUBLIC_ORIGIN" | "TENOR_ALLOWED_HOSTS" | "TENOR_MEDIA_ALLOWED_HOSTS">> {}
}
