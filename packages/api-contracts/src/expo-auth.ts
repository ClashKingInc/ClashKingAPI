...
const Conflict = [{ status: 409, body: ErrorResponse }] as const
...
const nativeAuth = <Body extends typeof DiscordBody | typeof EmailBody | typeof VerifyEmailBody | typeof ResetPasswordBody>(operationId: string, path: `/v2/${string}`, body: Body) =>
  defineEndpoint({
    operationId,
    method: "POST",
    path,
...
const webAuth = <Body extends typeof DiscordBody | typeof EmailBody | typeof VerifyEmailBody | typeof ResetPasswordBody>(operationId: string, path: `/v2/${string}`, body: Body) =>
  defineEndpoint({
    operationId,
    method: "POST",
    path,
...
export const AuthResendVerificationEndpoint = defineEndpoint({
  ...
  responseMode: "json",
  successStatus: 200,
  errors: [{ status: 404, body: ErrorResponse }, { status: 410, body: ErrorResponse }] as const,
})
