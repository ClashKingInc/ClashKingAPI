...
func capitalBulk(a apptypes.Deps) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		tags := legacyCapitalFixTags(body.ClanTags[:capitalMin(len(body.ClanTags), 100)])
...
func legacyCapitalFixTags(tags []string) []string {
...
func legacyCapitalAsString(v any) string {
