...
export declare const CwlSummaryExportEndpoint: import("./endpoint.js").Endpoint<Schema.Struct<{}>, Schema.Struct<{
    readonly tag: Schema.String;
}>, Schema.Struct<{}>, Schema.instanceOf<Response, Response>, readonly [{
    readonly status: 400;
...
export declare const PlayerWarStatsExportEndpoint: import("./endpoint.js").Endpoint<Schema.Struct<{}>, Schema.Struct<{}>, Schema.Struct<{
    readonly player_tag: Schema.String;
    readonly timestamp_start: Schema.optionalKey<Schema.Number>;
    readonly timestamp_end: Schema.optionalKey<Schema.Number>;
    readonly limit: Schema.optionalKey<Schema.Int>;
}>, Schema.instanceOf<Response, Response>, readonly [{
    readonly status: 400;
    readonly body: Schema.Struct<{
        readonly code: Schema.Literals<readonly ["invalid_request", "validation_failed", "unauthenticated", "forbidden", "not_found", "conflict", "rate_limited", "payload_too_large", "unprocessable_entity", "not_implemented", "upstream_unavailable", "internal_error"]>;
        readonly message: Schema.String;
...
//# sourceMappingURL=expo-exports.d.ts.map