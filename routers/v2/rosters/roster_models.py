...
class CreateRosterModel(BaseModel):
    ...
    # Event system
    event_type: Optional[Literal["cwl", "clan-games", "raids", "rush", "tournament"]] = Field(None,
                                                                                              description="Predefined event type")
    event_instance: Optional[str] = Field(None,
                                          description="Auto-generated event instance (e.g. 'cwl-2025-01') - set by system")
