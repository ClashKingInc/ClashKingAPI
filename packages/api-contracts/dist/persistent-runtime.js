...
export const RuntimeUUID = Schema.String.check(Schema.isPattern(/^[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/iu));
...
export const TicketAccountSelectForm = TicketAccountSelectFormBase.check(Schema.makeFilter((form) => form.minValues <= form.maxValues && form.maxValues <= form.options.length
