...
const version = "0.1.0-rc.16", tag = `v${version}`, commit = "a".repeat(40)
...
test("requires a coherent package pair and matching GitHub Release tag", () => {
  ...
  for (const badTag of [undefined, "api-packages-v0.1.0-rc.16", "v0.1.0-rc.5"]) {
    assert.throws(() => validatePair(...packages(), badTag), /Release tag/u)
  }
  const pair = packages()
  pair[1].dependencies[packageNames[0]] = "^0.1.0-rc.16"
